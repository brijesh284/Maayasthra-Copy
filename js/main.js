/* -------------------------------------------------------
 ...
 Theme Name: Maayasthra
 Theme URL: https://Maayasthrahtml.themezaa.com/
 Description: Your Creative, Media & Technology Transformation Partner
...
(function ($) {
  ...
  if (typeof $.fn.magnificPopup === 'function') {
    if ($('#subscribe-popup').length > 0) {
      let delaySecond = 1.5,
        expireDays = 30,
        cookieName = 'Maayasthra-promo-popup';
